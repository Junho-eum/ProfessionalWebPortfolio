...
import '../components/styles/CardSliderPageFour.css'; // assuming you moved your CSS into this file

const CardSliderPageFourTwo = () => {
  ...
  return (
    <div>
      <h1 className="sliderTitle">Interaction Plots</h1>
      <div id="slider">
...
export default CardSliderPageFourTwo;
