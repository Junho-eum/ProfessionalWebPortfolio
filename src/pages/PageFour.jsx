...
import InteractionComp from "../components/Interaction";
        ...
        <div>
            ...
            >
                ...
                <div className="et-hero-tabs-container" ref={tabContainerRef}>
                    <a className="et-hero-tab" href="#tab-intro">INTRO</a>
                    <a className="et-hero-tab" href="#tab-methodology">Methodology</a>
                    <a className="et-hero-tab" href="#tab-PCA">PCA</a>
                    <a className="et-hero-tab" href="#tab-interaction">Interaction</a>
                    <a className="et-hero-tab" href="https://github.com/Junho-eum/Baseball_Analytics/blob/main/KBO_analytics_draft3.pdf">README</a>
            ...
            <main className="et-main">
                ...
                <div className="header-container">
                    ...
                    <h3>Pythagorean Expectation in baseball, which proposes a
            proportional win-loss ratio and their runs ratio, doesn't always hold true. Some teams deviate from this
            ...
            <h3 className='intro2'>The Pythagorean Expectation theory may not fully capture the complexities and variabilities in sports like baseball. A 3D plot of KBO data indicates the presence of outliers that the theory doesn't readily explain. These outliers could be attributed to exceptional performances, strong pitching, or random fluctuations. This paper will investigate these contributing factors and attempt to provide a better understanding of these deviations. By analyzing features that has strong influence on wins in KBO I aim to identify distinctive characteristics that may influence these outliers. </h3>
                ...
                <ul>
                    ...
                    <li class="list-title">
                        <h3>Regression Analysis to Understand Influence of Batting and Pitching Variables</h3>
                        <ul>
                    ...
                    <li class="list-title">
                        <h3>Principal Component Analysis with Gaussian Mixture Model</h3>
                        <ul>
                    ...
                    <section className="et-slide-3 section3" id="tab-PCA">
                        <div className="header-container">
                            ...
                            <p>In the analysis, PCA was used to manage the high dimensionality of the dataset. This technique transformed the data into new orthogonal features, or "components", each representing a certain amount of the dataset's total variance. Sixteen KBO batting features were selected for this analysis, based on their strong interactions and impact on a team's offensive performance. By observing a scree plot and considering the cumulative explained variance, I decided to retain six components from the PCA. These components captured 92.3% of the variation in the dataset, effectively condensing the information of 16 variables into 6, which greatly facilitated the subsequent GMM clustering.</p>
                            <br></br>
                            <h1 className='intro1'>Interpretation of PCA Components</h1>
                            <p>
                            The six retained PCA components each reveal different aspects of a team's performance:
                            <br></br><br></br>
                            <strong>1. Overall Offensive Performance:</strong> A team's general offensive performance is captured by this component. It suggests that teams with high scores show strong offensive performances, yet fewer sacrifice hits.
                            <br></br><br></br>
                            <strong>2. Plate Discipline and Speed:</strong> This component represents a mix of plate discipline and speed. High-scoring teams here display good discipline, proficient contact-making, and potentially have fast runners.
                            <br></br><br></br>
                            <strong>3. Speed and Opportunism:</strong> This indicates a tendency for speed and situational play. High-scoring teams might be fast, seizing scoring opportunities, but may not hit many home runs.
                            <br></br><br></br>
                            <strong>4. Sacrifice Play:</strong> Teams that often opt for sacrifice for the overall score are captured by this component.
                            <br></br><br></br>
                            <strong>5. Aggressive Play and Efficiency:</strong> Represents a blend of aggressive play and efficient hitting. High-scoring teams could be hit by pitches often, draw walks, and hit efficiently for extra bases.
                            <br></br><br></br>
